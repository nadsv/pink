...
function() {
    ...
    function setEndDate(elem) {
        var beginDate = elem.getMoment(), duration = parseInt(document.getElementById("duration").value), momentDuration = moment.duration(duration, "d"), endDuration = beginDate.add(momentDuration);

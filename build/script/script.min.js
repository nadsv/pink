!function() {
    ...
    function replaceIndexes(elem, index) {
        var tmpl = elem.innerHTML, newIndex = parseInt(index) - 1, oldPostfix = index + '"', rexp = new RegExp(oldPostfix, "g"), newPostfix = newIndex + '"', newTmpl = tmpl.replace(rexp, newPostfix);
